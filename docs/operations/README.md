...
| [Meta control plane](meta-control-plane.md) | Creating the first single-Data cluster, starting plaintext or mTLS Meta clusters, changing membership, replacing binaries, handling snapshot/WAL incidents, and exporting audit or operation archives |
