...
| Meta control plane | NuRaft-backed metadata, static multi-member genesis, topology-owned single-Data-cluster lifecycle and atomic creation admission, Data-session publishing, cluster status, leader-owned workflow recovery, membership identity, and WAL/snapshots | [Meta control plane](08-meta-control-plane.md) |
